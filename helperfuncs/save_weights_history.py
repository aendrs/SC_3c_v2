...
def save_weights_history(history, model=None, scriptname=None,timeelapsed=0, YMDfolder=True, directorypath='.'): 
    ...
    with open(filepath, "a") as text_file:
            ...
            print(history.history['acc'], file=text_file)
            print('val_loss:', file=text_file)
            print(history.history['val_loss'], file=text_file)
            print('val_acc:', file=text_file)
            print(history.history['val_acc'], file=text_file)
            print('=======================================================', file=text_file)
            print('=======================================================', file=text_file)
